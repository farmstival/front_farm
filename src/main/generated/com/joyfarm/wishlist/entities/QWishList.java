package com.joyfarm.wishlist.entities;
...
public class QWishList extends EntityPathBase<WishList> {
    ...
    private static final long serialVersionUID = 1530924954L;
    ...
    public final EnumPath<com.joyfarm.wishlist.constants.WishType> wishType = createEnum("wishType", com.joyfarm.wishlist.constants.WishType.class);
